...
Source.create(name: 'LeMonde', language: 'fr', display: false, rss_url: 'http://rss.lemonde.fr/c/205/f/3050/index.rss')
...
Source.create(name: 'LeParisien', language: 'fr', display: false, rss_url: 'http://www.leparisien.fr/une/rss.xml')
Source.create(name: 'LePoint', language: 'fr', display: false, rss_url: 'http://www.lepoint.fr/24h-infos/rss.xml')
